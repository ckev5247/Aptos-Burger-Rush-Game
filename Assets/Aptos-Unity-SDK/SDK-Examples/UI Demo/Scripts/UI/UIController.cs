...
namespace Aptos.Unity.Sample.UI
{
    public class UIController : MonoBehaviour
    {
        ...
        [SerializeField] private PanelTab shopTab;
        ...
        {
            StartCoroutine(AptosUILink.Instance.BuyGameNFT(index,false));
        }
        public void BuyMoney()
        {
            StartCoroutine(AptosUILink.Instance.BuyGameMoney());
        }
